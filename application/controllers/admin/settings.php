...
class Settings extends Admin_Controller
{
  ...
  function index()
  {
    ...
    $config['field']['frontend_multi_language'] = array('type'=>'boolean');
    ...
    //$config['field']['sharethis_services'] = array('type'=>'sharethischeckbox','params'=>array('options'=>array('facebook','twitter','yahoo','gbuzz','email')));
