<?php 
/* application/modules/menus/views/admin/admin_home_cont */
...
function generateRowsByLevel($navlist, &$output, $depth = 0,$pages,$languages, $multi_language) 
{
    ...
    if($multi_language==1)
    {
        ...
        $output .= anchor("kaimonokago/admin/changeStatus/menus/".$list['id'],'<img src="'.base_url().'assets/icons/'.$active_icon.'.png"  alt="'.$active_icon.'" />', array('class' => $list['status']. ' changestatus'));
        $output .= "</td>\n";
...
{
    // begin table
    $output = "<div  id='tablesorter1'><table border='1' cellspacing='0' cellpadding='3' width='100%'>\n";
    $output .= "<thead>\n<tr valign='top'>\n";
